...
export class RenderNode {
  private _root_: [INodeRootWorker] = [
    {
      __path__: "",
  ...
  private _traverse_(
    callback: (node: INodeRootWorker | INodeWorker) => void,
    node: INodeRootWorker | INodeWorker
  ) {
    callback(node)
  ...
  replaceNode(
    ...
    this._updateLocationNodes_($parent.nodes, $parent as any)
  ...
  moveNodeByPath(
    ...
    this._updateLocationNodes_($parentFrom.nodes, $parentFrom as any)
    this._updateLocationNodes_($parentTo.nodes, $parentTo as any)
