...
export const draw_rectangle_context_webgl2 = (context: WebGL2RenderingContext, options: IOptionsNodeRectangle & TOptionsBasic) => {
  ...
  if (rectProgram) {
    ...
    context.drawElements(context.TRIANGLES, rectProgram.indices.length, context.UNSIGNED_SHORT, 0);
  }
}
